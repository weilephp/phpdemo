    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/ykj/index.php/Admin/Link/edi" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="catename" name="url" size="50" value="<?php echo ($data["url"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>链接描述：</th>
                                <td>
                                    <textarea id="descr" name="descr" style="width:400px;height:100px;"><?php echo ($data["descr"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
