    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/ykj/index.php/Admin/Article/edi" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                <th>文章描述：</th>
                                <td>
                                    <textarea class="common-text required" name="descr" id="descr" style="width:400px;height:100px;"><?php echo ($data["descr"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th>文章缩略图：</th>
                                <td>
                                    <input class="required" id="pic" name="pic" type="file">
                                    <img src="/ykj/<?php echo ($data["pic"]); ?>" width="100px" height="40px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="cateid">
                                        <?php if(is_array($catename)): $i = 0; $__LIST__ = $catename;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $data['cateid']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
