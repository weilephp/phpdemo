    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/ykj/index.php/Admin/Admin/edi" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>管理员名称：</th>
                                <td>
                                    <input class="common-text required" id="username" name="username" size="50" value="<?php echo ($data["username"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>密码：</th>
                                <td>
                                    <input class="common-text required" id="password" name="password" size="50" value="" type="text" placeholder="为空表示不修改">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
