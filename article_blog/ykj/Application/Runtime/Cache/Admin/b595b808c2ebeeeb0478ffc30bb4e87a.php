...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎来到后台管理系统</span><span style="color:red;margin:0px 20px;">wwl独家创造</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    ...
                    <a href="/ykj/index.php/Admin/Cate/add"><i class="icon-font">&#xe041;</i>新增文章分类</a>
