                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td></td> -->                               
                                <td>
                                    <?php if($vo['username'] != 'admin'): ?><a class="link-update" href="/ykj/index.php/Admin/Admin/edi/id/<?php echo ($vo["id"]); ?>">修改</a>
                                        <a class="link-del" onclick="return confirm('确定要删除吗')" href="/ykj/index.php/Admin/Admin/del/id/<?php echo ($vo["id"]); ?>">删除</a><?php endif; ?>
                                </td>
