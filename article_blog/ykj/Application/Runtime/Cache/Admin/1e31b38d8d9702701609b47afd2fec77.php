            ...
            <form name="myform" id="myform" method="post" action="/ykj/index.php/Admin/Cate/sort">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a id="updateOrd" href="javascript:sort()"><i class="icon-font"></i><input type="submit" value="更新排序"></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td></td> -->
                                <td>
                                    <a class="link-update" href="/ykj/index.php/Admin/Cate/edi/id/<?php echo ($vo["id"]); ?>">修改</a>
                                    <a class="link-del" onclick="return confirm('确定要删除吗')" href="/ykj/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
