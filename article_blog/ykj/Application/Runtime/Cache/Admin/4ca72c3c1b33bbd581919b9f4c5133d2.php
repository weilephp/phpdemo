    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/ykj/index.php/Admin/Cate/edi" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="sort" name="sort" size="50" value="<?php echo ($data["sort"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
