...
<title>第一个小成品</title>		<script type="text/javascript">
...
<ul class="excerpt thumb">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
			<a href="/ykj/index.php/Home/Article/article/id/<?php echo ($vo["id"]); ?>" class="pic"><img src="/ykj/<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["title"]); ?>" /></a>			
			<h2 class="excerpt-tit"><a href="/ykj/index.php/Home/Article/article/id/<?php echo ($vo["id"]); ?>" ><?php echo ($vo["title"]); ?></a></h2>
