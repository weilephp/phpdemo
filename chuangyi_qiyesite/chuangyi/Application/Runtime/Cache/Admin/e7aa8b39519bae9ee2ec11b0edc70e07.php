    ...
    <form method="post" action="" enctype="multipart/form-data">
      <table class="add" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="cf_name"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">配置英文名</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="cf_ename"></td>
        </tr>
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" align="left">
            <input type="radio" name="cf_type" value="text" checked="checked">单行文本
            <input type="radio" name="cf_type" value="radio">单选按钮
            <input type="radio" name="cf_type" value="textarea">多行文本
          </td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">可选值</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><textarea name="cf_values"></textarea></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">默认值</span></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19" align="left"><textarea name="cf_value"></textarea></td>
        </tr>
