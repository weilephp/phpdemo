...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              ...
              全选      &nbsp;&nbsp;<img src="http://localhost/weile/chuangyi/Application/Admin/Public/images/add.gif" width="10" height="10" /><a href="/weile/chuangyi/index.php/Admin/Cate/add" class="lstTop"> 添加</a>   &nbsp; <img src="http://localhost/weile/chuangyi/Application/Admin/Public/images/del.gif" width="10" height="10" /> 删除    &nbsp;&nbsp;<img src="http://localhost/weile/chuangyi/Application/Admin/Public/images/edit.gif" width="10" height="10" /> 编辑   &nbsp;</span><span class="STYLE1"> &nbsp;</span></div></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><table class="add" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE2" align="left"><input type="radio" name="cate_type" checked="checked">封面栏目<input type="radio" name="cate_type">列表栏目<input type="radio" name="cate_type">产品栏目</td>
      </tr>
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19" align="left">
            <select>
                <option selected="selected" hidden="hidden">请选择父栏目</option>
                <option>封面栏目</option>
            </select>
        </td>
      </tr>
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" align="left"><textarea id="content"></textarea></td>
      </tr>
      <tr>
