          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 栏目列表显示</span></td>
              </tr>
            </table></td>
            <td><div align="right"><span class="STYLE1">
              <input type="checkbox" name="checkbox11" id="checkbox11" />
              全选      &nbsp;&nbsp;<img src="http://localhost/weile/chuangyi/Application/Admin/Public/images/add.gif" width="10" height="10" /><a href="/weile/chuangyi/index.php/Admin/Category/add" class="lstTop"> 添加</a>   &nbsp; <img src="http://localhost/weile/chuangyi/Application/Admin/Public/images/del.gif" width="10" height="10" /><a href="#" class="lstTop" id="deleteAll"> 删除 </a>   &nbsp;&nbsp;<img src="http://localhost/weile/chuangyi/Application/Admin/Public/images/edit.gif" width="10" height="10" /> 编辑   &nbsp;</span><span class="STYLE1"> &nbsp;</span></div></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td height="20" bgcolor="#FFFFFF"><div align="center">
            <input type="checkbox" name="delall" class="selall" value="<?php echo ($vo["cate_id"]); ?>" />
          </div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($vo["cate_id"]); ?></span></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left" style="padding-left:10px;"><?php echo str_repeat("&nbsp;",$vo['level']*3); echo ($vo["cate_name"]); ?></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
            <?php if($vo['cate_pic'] != ''): ?><img src="/weile/chuangyi/<?php echo ($vo["cate_pic"]); ?>" height="40px">
            <?php else: ?>
              暂时没有缩略图哦<?php endif; ?>
          </div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($vo["parentid"]); ?></div></td>
          <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
            <?php if($vo['cate_type'] == 0): ?>封面栏目
            <?php elseif($vo['cate_type'] == 1): ?>列表栏目
            <?php else: ?>产品栏目<?php endif; ?>
          </div></td>
          <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="/weile/chuangyi/index.php/Admin/Category/edit/cate_id/<?php echo ($vo["cate_id"]); ?>">修改</a> | <a href="/weile/chuangyi/index.php/Admin/Category/del/cate_id/<?php echo ($vo["cate_id"]); ?>" onclick="return confirm('确定要删除此栏目？');">删除</a></div></td>
...
<script type="text/javascript">
    ...
    $("#deleteAll").click(function(){
        ...
        if(flag){
          ...
          $.ajax({
              url:'/weile/chuangyi/index.php/Admin/Category/delall',
              method:'post',
              dataType:'json',
              data:{'id':id},
              tradition:true,
