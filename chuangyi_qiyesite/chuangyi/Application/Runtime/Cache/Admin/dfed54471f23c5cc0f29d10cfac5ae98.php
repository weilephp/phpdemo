...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 修改栏目</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    ...
    <form method="post" action="" enctype="multipart/form-data">
      ...
      <input type="hidden" name="id" value="<?php echo ($cateres["cate_id"]); ?>">
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">栏目名称</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="cate_name" value="<?php echo ($cateres["cate_name"]); ?>"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">栏目英文名称</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="cate_ename" value="<?php echo ($cateres["cate_ename"]); ?>"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">关键字</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="cate_keywords" value="<?php echo ($cateres["cate_keywords"]); ?>"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">栏目描述</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><textarea name="cate_descr" style="width:350px;height:50px;"><?php echo ($cateres["cate_descr"]); ?></textarea></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">缩略图</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="file" name="cate_pic">
            <?php if($cateres['cate_pic'] != ''): ?><img src="/weile/chuangyi/<?php echo ($cateres["cate_pic"]); ?>" height="50"><?php endif; ?>
          </td>
        </tr>
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" class="STYLE2" align="left">
            <input type="radio" name="cate_type" <?php if($cateres['cate_type'] == 0): ?>checked="checked"<?php endif; ?> value="0">封面栏目
            <input type="radio" name="cate_type" <?php if($cateres['cate_type'] == 1): ?>checked="checked"<?php endif; ?> value="1">列表栏目
            <input type="radio" name="cate_type" <?php if($cateres['cate_type'] == 2): ?>checked="checked"<?php endif; ?> value="2">产品栏目
          </td>
        </tr>
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" class="STYLE19" align="left">
              <select name="parentid">
                  ...
                  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cate_id"]); ?>" <?php if($cateres['parentid'] == $vo['cate_id']): ?>selected="selected"<?php endif; if($cateres['cate_id'] == $vo['cate_id']): ?>style="display:none;"<?php endif; ?>><?php echo str_repeat("&nbsp;",$vo['level']*3); echo ($vo["cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
          </td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">栏目内容</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><textarea id="content" name="cate_content"><?php echo ($cateres["cate_content"]); ?></textarea></td>
        </tr>
        <tr>
