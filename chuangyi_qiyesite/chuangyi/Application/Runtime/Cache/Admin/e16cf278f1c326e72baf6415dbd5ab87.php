    ...
    <form method="post" action="" enctype="multipart/form-data">
      <table class="add" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="ar_title"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">文章作者</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="text" name="ar_author"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">是否推荐</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="checkbox" name="ar_rem" value="1"></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">缩略图</span></div></td>
          <td height="20" bgcolor="#FFFFFF" align="left"><input type="file" name="ar_pic"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" align="left"><textarea id="content" name="ar_content"></textarea></td>
        </tr>
        <tr>
