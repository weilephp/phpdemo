    ...
    <form method="post" action="" enctype="multipart/form-data">
      <table class="add" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        ...
        <tr>
          ...
          <td height="20" bgcolor="#FFFFFF" class="STYLE2" align="left"><input type="radio" name="cate_type" checked="checked" value="0">封面栏目<input type="radio" name="cate_type" value="1">列表栏目<input type="radio" name="cate_type" value="2">产品栏目</td>
        </tr>
        <tr>
